...
def main():
    ...
    creds = flow.run_local_server(
        host="localhost",
        port=0,
        authorization_prompt_message="브라우저에서 Blogger 권한을 승인해 주세요.",
        success_message="Blogger 인증이 완료되었습니다. 이 창을 닫아도 됩니다.",
        open_browser=True
    )
    ...
    print(f"[성공] blogger_token.json 저장 완료: {TOKEN_OUTPUT_PATH}")
